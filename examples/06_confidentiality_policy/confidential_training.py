"""Confidential training step: the policy graph of multi-party AI.

    python examples/06_confidentiality_policy/confidential_training.py
    encompute compile examples/06_confidentiality_policy/confidential_training.py:step -o step.encompute
...
policy and rejects illegal flows at compile time. At run time, attested key
release (example 07) and secure aggregation (example 08) enforce it.
"""
