...
Dual licensing requires the copyright holder to be able to relicense every
line of code. External contributions can therefore only be accepted under a
contributor license agreement (CLA). Until a CLA is published, pull
requests from outside contributors cannot be merged; please open an issue
